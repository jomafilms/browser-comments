...
export async function reopenCommand(
  ...
  return {
    ...
    filters: {},
    count: 1,
    tickets: [{ id: dbId, display_number: byDisplayNumber ? id : 0, url: '', page_section: '', status: 'open', priority: '', priority_number: 0, assignee: '', submitter_name: '', text_annotations: [], created_at: '', updated_at: '' }],
  };
}
